<template>
  <div>
    ...
    <div class="header-actions">
      <!-- 账号管理 -->
      <el-tabs type="card">
        <el-tab-pane label="管理员端" name="first"></el-tab-pane>
        <el-tab-pane label="司机端" name="second"></el-tab-pane>
        <el-tab-pane label="用户端" name="third"></el-tab-pane>
      </el-tabs>
      <!-- 添加和搜索部分 -->
      <div class="word-actions">
        ...
        <el-button type="primary" @click="showAddModal">添加账号</el-button>
    ...
    <el-table :data="filteredAccounts">
      ...
      <el-table-column prop="authority" label="管理员权限"></el-table-column>
